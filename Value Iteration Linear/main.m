...
%         x0 = [x0(1)+0.2*(rand(1,1)-0.5);x0(2);x0(3)+0.1*(rand(1,1)-0.5);x0(4); 0];
%     end
    ...
    phi_next = [x1(1)^2 x1(1)*x1(2) x1(1)*x1(3) x1(1)*x1(4) ...
       x1(2)^2 x1(2)*x1(3) x1(2)*x1(4)...
       x1(3)^2 x1(3)*x1(4) x1(4)^2 ];
    
    index_w = size(ww);
    weight_prev = ww(:,index_w(2));
    Y(j,:) = x(length(t),5) - x(1,5) + weight_prev'*phi_next';
