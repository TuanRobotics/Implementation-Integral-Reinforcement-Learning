function xdot = irl_2ode_nonlinear(t,x)
    global K; global u; global fx; global gx; global Q; global R;
    global M; global m; global g; global L; global weights_opt; global dphi;
    global weights;
    global k;
    ...
    u = -0.5*inv(R)*gx'*dphi'*weights; % 0.01*(rand(1,1)-0.5)
